...
def main() -> None:
    ...
    local_rows = [
        ...
        ("Wallet-owned consumer confirmation", local["measured_seconds"]["wallet_owned_tree_confirmation"], duration(local["measured_seconds"]["wallet_owned_tree_confirmation"])),
    ]
    storage_rows = [
    ...
    attack_rows = [
        ...
        ("Referenced design, one attacked name/day", attack["referenced_commit_design"]["one_daily_window_candidates"] * attack["referenced_commit_design"]["referenced_pair_serialized_bytes"] / 1e9, bytes_label(attack["referenced_commit_design"]["one_daily_window_candidates"] * attack["referenced_commit_design"]["referenced_pair_serialized_bytes"])),
    ]
...
{bar_chart("Six-month local replay", local_rows, "Wall-clock seconds; current and referenced measured end-to-end, wallet consumer measured in-memory, other values derived")}
{lookup_chart(lookup)}
